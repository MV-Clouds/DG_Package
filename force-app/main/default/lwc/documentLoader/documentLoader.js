...
export default class DocumentLoader extends LightningElement {
    ...
    set fullSize(value){ this._fullSize = value === true || value === "true" ? true : false}

    _noBackdrop;		// In Case You Don't want to show backdrop effect...
    @api get noBackdrop(){ return this._noBackdrop}
    set noBackdrop(value){ this._noBackdrop = value === true || value === "true" ? true : false}
    ...
    set fixTop(value){ this._fixTop = value === true || value === "true" ? true : false}
	...
	get loadStyle(){
		...
		style += this.noBackdrop === true ? `background : transparent !important; backdrop-filter : none !important;` : '';
