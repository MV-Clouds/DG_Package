...
export default class RelatedRecordList extends LightningElement {
    ...
    handleButtonClick() {
        ...
        const url = `/lightning/cmp/MVDG__generateDocumentV2?c__objectApiName=${this.objectname}&c__isRelatedList=true&c__isDefaultGenerate=true&c__templateIdToGenerate=${this.templateId}&c__parentId=${this.parentId}&c__relationshipName=${this.relationshipName}&c__parentObjName=${this.parentObj}&c__ids=${this.selectedIds.join(',')}`;
